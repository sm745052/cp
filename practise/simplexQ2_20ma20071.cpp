...
int main()
{
	...
	while (1)
	{
		cout << "(a) List of all BFS (b) Print the initial simplex table (c) List of all Non-basic variables in the initial table (d) List of Basic variables along with ratios in the just before iteration (e) simplex table of the second iteration" << endl;
		char ch;
		cin >> ch;
		switch (ch)
		{
		...
		case 'd':
			...
			break;
		case 'e':
			bool res = simplex.simplex_iteration();
			simplex.print('t');
		}
	}
	return 0;
